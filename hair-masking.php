<?php include 'inc/header.php'; ?>
	<div class="clip-heading">
		<h1 style="color: #fff;">Hair Masking</h1>
	</div>
	<div class="clip-area">
		<div class="clip-content container">
<?php 
	$query = "SELECT * FROM tbl_all_pages WHERE position='pageheader' && category='Hair Masking' order by id DESC limit 1 ";
...
<?php 
	$query = "SELECT * FROM tbl_all_pages WHERE category='Hair Masking' order by id DESC ";
	$position = $db->select($query);
	if ($position) {
		while ($result = $position->fetch_assoc()) {
?>
