  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sectionContent = mysqli_real_escape_string($db->link, $_POST['content']);
        ...
        if ($sectionTitle == "") {
          ...
          $query = "UPDATE start_content SET 
                  title = '$sectionTitle', 
                ...
                if ($insert_section) {
                 $n = "<span class='add_message'>Content updated Successfully. </span>";
                }else {
                 $n = "<span class='add_message'>Content Not updated .!</span>";
                }
        }
  }
?>
<div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center">
                  <h2 class="h5 display">Update Content</h2>
                </div>
                <div class="card-body">
<?php 
  $query = "SELECT * FROM start_content WHERE id='$id' ";
