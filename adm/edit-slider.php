	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($sliderTitle == "") {
        	...
        	$query = "UPDATE tbl_slider SET 
                ...
                if ($insert_slider) {
                 $n = "<span class='add_message'>Slider updated Successfully. </span>";
                }else {
...
<div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
<?php 
  $querry = "SELECT * FROM tbl_slider WHERE id='$id'";
...
?>
                  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="slider_title" class="form-control" value="<?php echo $result['slider_title']; ?>">
                      </div>
                    </div>
                    <div class="line"></div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="file" name="slider_image" class="form-control"><span class="help-block-none" value="<?php echo $result['slider_image']; ?>"></span>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input style="cursor: pointer;" type="submit" name="submit" value="Update Slider" class="btn btn-primary btn-block">
                      </div>
                    </div>                    
                  </form>
<?php } ?>
