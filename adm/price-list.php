...
<div class="container">
  ...
  <tbody>
<?php 
    $query = "SELECT * FROM tbl_pricing ORDER BY id DESC";
...
?>
    <tr>
      ...
      <td>
        <a href="edit-price.php?price_edit=<?php echo $result['id']; ?>" style="font-size: 23px;color: #55b365;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
